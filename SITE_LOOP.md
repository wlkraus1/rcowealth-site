...
- [ ] **1. A mobile visitor to any deep link lands on the homepage instead.** Highest value in this file: it is a conversion defect and an SEO defect at once, and it is exactly the "links that need fixing".
